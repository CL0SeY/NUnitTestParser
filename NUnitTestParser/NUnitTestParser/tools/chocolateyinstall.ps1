...
$packageName = 'NUnitTestParser' # arbitrary name for the package, used in messages
...
$packageArgs = @{
  ...
  # optional
  registryUninstallerKey = 'NUnitTestParser' #ensure this is the value in the registry
  checksum      = ''
